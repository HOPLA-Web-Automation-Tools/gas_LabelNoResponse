...
var ignoreLabel = userProperties.getProperty("ignoreLabel") || 'Ignore No Response';
var minTime = userProperties.getProperty("minTime") || '5d'; // 5 days
var maxTime = userProperties.getProperty("maxTime") || '14d'; // 14 days
var noResponse_checkFrequency_HOUR = userProperties.getProperty("noResponse_checkFrequency_HOUR") || 1;
...
function doGet(e) {
  if (e.parameter.setup) { // SETUP
    ...
    script_status = userProperties.getProperty("status");
